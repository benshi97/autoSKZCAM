...
def skzcam_generate_job(
    ...
    if not hasattr(EmbeddedCluster, "adsorbate_slab") or EmbeddedCluster.adsorbate_slab is None:
        EmbeddedCluster.convert_slab_to_atoms()

    # Ensure that the pun_file has been provided in EmbeddedCluster
    if not hasattr(EmbeddedCluster, "pun_file") or EmbeddedCluster.pun_file is None:
        raise ValueError(
...
def chemshell_run_job(
    SkzcamCluster: CreateEmbeddedCluster,
