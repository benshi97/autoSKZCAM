...
With a nice name in mind, [create a new repository](https://github.com/new?autoSKZCAM_name=autoSKZCAM&autoSKZCAM_owner=Quantum-Accelerators) using this autoSKZCAM. Give it a name, a description, and decide if you want it to be public or private.
